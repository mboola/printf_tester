...
TESTS_USER = ${TEST1_USER_OUTPUT} ${TEST2_USER_OUTPUT} ${TEST3_USER_OUTPUT} ${BONUS1_USER_OUTPUT} ${BONUS2_USER_OUTPUT} ${BONUS3_USER_OUTPUT} ${BONUS4_USER_OUTPUT} ${BONUS5_USER_OUTPUT}
TESTS_EXE = ${TEST1} ${TEST2} ${TEST3} ${BONUS1} ${BONUS2} ${BONUS3} ${BONUS4} ${BONUS5}
RESULTS = ${TEST1_RESULT} ${TEST2_RESULT} ${TEST3_RESULT} ${BONUS1_RESULT} ${BONUS2_RESULT} ${BONUS3_RESULT} ${BONUS4_RESULT} ${BONUS5_RESULT}
OBJ = ${OBJ_TEST1} ${OBJ_TEST2} ${OBJ_TEST3} ${OBJ1_BONUS} ${OBJ2_BONUS} ${OBJ3_BONUS} ${OBJ4_BONUS} ${OBJ5_BONUS}
...
# runs all tests
run: test1 test2 test3 bonus1 bonus2 bonus3 bonus4 bonus5
