...
BONUS9_DIR = ${BONUS_DIR}/bonus9
BONUS9_FILE = ${BONUS9_DIR}/bonus9.c
OBJ9_BONUS = ${BONUS9_FILE:.c=.o}
BONUS9 = bonus9_exe
BONUS9_USER_OUTPUT = ${BONUS9_DIR}/bonus9_user_output.txt
BONUS9_OK_OUTPUT = ${BONUS9_DIR}/bonus9_ok_output.txt
BONUS9_RESULT = ${BONUS9_DIR}/bonus9_result.txt
...
TESTS_USER	=	${TEST1_USER_OUTPUT} ${TEST2_USER_OUTPUT} ${TEST3_USER_OUTPUT} \
				...
				${BONUS7_USER_OUTPUT} ${BONUS8_USER_OUTPUT} ${BONUS9_USER_OUTPUT}
...
bonus9: ${BONUS9}
	./$< > ${BONUS9_USER_OUTPUT}
	-diff -s ${BONUS9_USER_OUTPUT} ${BONUS9_OK_OUTPUT} > ${BONUS9_RESULT}	
